...
COINGECKO_API_KEY=your-coingecko-api-key-here  # Optional but recommended
...
- ✅ Review [Security Policy](docs/SECURITY.md) before setup
...
1. **Fetches** top trending news from [Leviathan News API](https://api.leviathannews.xyz)
